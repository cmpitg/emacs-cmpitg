;;; cmpitg-random-light-theme.el --- Emacs theme with a light background.
...
(provide-theme 'cmpitg-random-light)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; cmpitg-random-light-theme.el ends here
