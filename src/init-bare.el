...
(require 'rmacs:config-package-manager  (~get-config "config-package-manager-rewrite"))
(require 'rmacs:config-core-edit        (~get-config "config-core-edit"))
(require 'rmacs:config-core-behaviors   (~get-config "config-core-behaviors"))
(require 'rmacs:config-core-functions   (~get-config "config-core-functions"))
(require 'rmacs:config-core-keybindings (~get-config "config-core-keybindings"))
(require 'rmacs:config-ipc              (~get-config "config-ipc-rewrite"))
