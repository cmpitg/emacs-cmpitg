...
(with-eval-after-load "evil"
  ...
  (~bind-key-with-prefix "b l" #'~choose-buffer)
  ...
  (bind-key "<s-return>" #'~execute-text-from-context)
  (bind-key "<C-down-mouse-1>" nil)
  ;; (bind-key "<C-mouse-1>" #'~execute-text-from-context)
  (bind-key "<down-mouse-2>" nil)
  (bind-key "<mouse-2>" #'~execute-text-from-context)
